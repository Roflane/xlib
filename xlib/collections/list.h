...
namespace xlib {
    ...
    public:
        ...
        public:
            ...
            Iterator operator-(const size_t dec) {
                auto temp = current;
                size_t i = 0;
        ...
        list() : _length(0), _pHead(nullptr), _pTail(nullptr) {}
        list(const list &other) : _length(other._length), _pHead(other._pHead), _pTail(other._pTail) {}
        ...
        void insert_after_id(const T &v, const size_t id) {
